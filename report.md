...
* **Датасет:**  В проекте используется датасет [`medical_questions_pairs`](https://huggingface.co/datasets/medical_questions_pairs),  содержащий пары вопросов на английском языке,  связанных с медицинской тематикой.  Датасет включает в себя метки,  указывающие,  являются ли вопросы в каждой паре похожими или нет.
...
Цветная версия
![Цветная версия](/images/image-3.png)
